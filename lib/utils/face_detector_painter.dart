...
import 'package:face_detection_app/utils/coordinates_painter.dart';
      ...
      void paintContour(final FaceContourType type) {
        ...
        if (faceContour?.points != null) {
          for (final Point point in faceContour!.points) {
            canvas.drawCircle(
                Offset(
                    translateX(point.x.toDouble as double, rotation, size,
                        absoluteImageSize),
                    translateY(point.y.toDouble as double, rotation, size,
                        absoluteImageSize)),
                1.0,
                paint);
          }
